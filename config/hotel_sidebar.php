    ...
    'groups' => [
        [
            ...
            'items' => [
                ...
                ['label' => 'Messages', 'icon' => 'fa fa-envelope-o', 'features' => ['channel_manager']],
                ['label' => 'OTA Content', 'icon' => 'fa fa-th', 'features' => ['channel_manager']],
                ['label' => 'Reviews', 'icon' => 'fa fa-star', 'features' => ['reviews_reputation_management']],
                ...
                ['label' => 'Payment Gateway', 'icon' => 'fa fa-link', 'features' => ['channel_manager']],
                ['label' => 'Logs', 'icon' => 'fa fa-file-text-o', 'features' => ['channel_manager', 'revenue_management_software']],
            ],
        ],
        [
            'key' => 'pms',
            ...
            'items' => [
                ...
                ['label' => 'Stay View', 'icon' => 'fa fa-bed', 'features' => ['property_management_system']],
                ['label' => 'Rooms View', 'icon' => 'fa fa-calendar', 'features' => ['property_management_system']],
                ['label' => 'Reservation', 'icon' => 'fa fa-plus', 'features' => ['property_management_system']],
                ['label' => 'Guests', 'icon' => 'fa fa-id-card-o', 'features' => ['property_management_system']],
                ['label' => 'Companies', 'icon' => 'fa fa-building-o', 'features' => ['property_management_system']],
                ['label' => 'Reports', 'icon' => 'fa fa-file-text-o', 'features' => ['property_management_system']],
                ['label' => 'Expenses', 'icon' => 'fa fa-dollar', 'features' => ['accounting_expenses_system']],
                ['label' => 'Leads', 'icon' => 'fa fa-bars', 'features' => ['crm_leads_management_system']],
                ['label' => 'Payment Gateway', 'icon' => 'fa fa-link', 'features' => ['property_management_system']],
                ['label' => 'Logs', 'icon' => 'fa fa-file-text-o', 'features' => ['property_management_system']],
            ],
        ],
        [
            'key' => 'erp',
            ...
            'items' => [
                ...
                ['label' => 'Accounts', 'icon' => 'fa fa-calculator', 'features' => ['accounting_expenses_system']],
        ...
        [
            ...
            'items' => [
                ['label' => 'Hotel Performance', 'icon' => 'fa fa-line-chart', 'features' => ['revenue_management_software']],
                ['label' => 'Daily Report', 'icon' => 'fa fa-columns', 'features' => ['revenue_management_software']],
                ['label' => 'Trend Analysis', 'icon' => 'fa fa-bar-chart', 'features' => ['revenue_management_software']],
                ['label' => 'Dynamic Pricing', 'icon' => 'fa fa-area-chart', 'features' => ['revenue_management_software']],
                ['label' => 'Pick Up Report', 'icon' => 'fa fa-chevron-circle-up', 'features' => ['revenue_management_software']],
            ],
        ],
        [
            'key' => 'booking_engine',
